...
def calculate_c_2_unpolarized_bh( 
    ...
    try:
        ...
        first_part_of_contribution = (Decimal("4.") * _MASS_OF_PROTON_IN_GEV**2 / squared_hadronic_momentum_transfer_t) * weighted_combination_of_form_factors
        
        # (4):  Multiply by the prefactor to obtain the coefficient.
        c2_unpolarized_BH = Decimal("8. ") * x_Bjorken**2 * shorthand_k**2 * (first_part_of_contribution + Decimal("2.") * addition_of_form_factors_squared)
