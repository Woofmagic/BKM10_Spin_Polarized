...
def calculate_s_2_minus_plus_longitudinally_polarized_A(
    ...
    try:
        ...
        one_minus_two_xb = 1. - 2. * x_Bjorken

        # (4): Calculate the first three terms of the brackets:
        first_three_terms = 1. + 4. * k_tilde**2 / squared_Q_momentum_transfer + root_one_plus_epsilon_squared

        # (5): Calculate the second part of the brackets:
        second_bracket_term = 2. * t_over_Q_squared * (one_minus_two_xb - x_Bjorken * root_one_plus_epsilon_squared) - t_over_Q_squared * one_minus_two_xb * (one_minus_two_xb - root_one_plus_epsilon_squared )

        # (6): Calculate the prefactor:
        prefactor = 4. * target_polarization * (2. - lepton_energy_fraction_y) * (1. - lepton_energy_fraction_y - lepton_energy_fraction_y**2 * epsilon**2 / 4.) * x_Bjorken * t_over_Q_squared / root_one_plus_epsilon_squared**6
