...
from coefficients.interference_coefficients.unpolarized.unpolarized_curly_C0p import calculate_curly_C_zero_plus_unpolarized_interference
...
def calculate_c_1_interference_coefficient(
    ...
    try:
        ...
        if target_polarization == 0.0:
            ...
            c_plus_plus = calculate_c_1_plus_plus_unpolarized(
                squared_Q_momentum_transfer,
                x_Bjorken,
                squared_hadronic_momentum_transfer_t,
                epsilon,
            ...
            c_zero_plus = calculate_c_1_zero_plus_unpolarized(
                squared_Q_momentum_transfer,
                x_Bjorken,
                squared_hadronic_momentum_transfer_t,
                epsilon,
...
def calculate_c_2_interference_coefficient(
    ...
    try:
        ...
        if target_polarization == 0.0:
            ...
            c_plus_plus = calculate_c_2_plus_plus_unpolarized(
                squared_Q_momentum_transfer,
                x_Bjorken,
                squared_hadronic_momentum_transfer_t,
                epsilon,
            ...
            c_zero_plus = calculate_c_2_zero_plus_unpolarized(
                squared_Q_momentum_transfer,
                x_Bjorken,
                squared_hadronic_momentum_transfer_t,
                epsilon,
...
def calculate_c_3_interference_coefficient(
    ...
    try:
        ...
        # (): If verbose, print the output:
        if verbose:
            print(f"> Calculated c_3 interference coefficient to be:\n{c_3_interference_coefficient}")
