...
def calculate_c_2_minus_plus_longitudinally_polarized_V(
    ...
    try:
        ...
        prefactor = -2. * lepton_polarization * target_polarization * lepton_energy_fraction_y * (1. - lepton_energy_fraction_y - (lepton_energy_fraction_y**2 * epsilon**2 / 4.)) * t_over_Q_squared / root_one_plus_epsilon_squared**5
