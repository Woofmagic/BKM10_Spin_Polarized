...
def calculate_s_1_minus_plus_longitudinally_polarized_V(
    ...
    try:
        ...
        prefactor_first_bracket_term = Decimal("2.") - Decimal("2.") * lepton_energy_fraction_y + lepton_energy_fraction_y**2 + lepton_energy_fraction_y**2 * epsilon**2 / Decimal("2.0")

        # (5): Calculate the first bracket term main stuff:
        main_first_bracket_term = Decimal("3.0") + Decimal("2.") * epsilon**2 + root_one_plus_epsilon_squared - Decimal("2.") * x_Bjorken * fancy_epsilon_term - t_over_Q_squared * (Decimal("1.") - Decimal("2.") * x_Bjorken) * (Decimal("1.") - Decimal("2.") * x_Bjorken - root_one_plus_epsilon_squared)

        # (6): Calculate the prefactor for the second bracket termL
        prefactor_second_bracket_term = Decimal("1.") - lepton_energy_fraction_y - lepton_energy_fraction_y**2 * epsilon**2 / Decimal("4.0")
        
        # (7): Calculate the main stuff in second bracket term:
        second_part_main_second_bracket_term = Decimal("2.") * t_over_Q_squared * (Decimal("2.") * fancy_epsilon_term - epsilon**2 - 12. * x_Bjorken * (Decimal("1.") - x_Bjorken) - Decimal("4.") * x_Bjorken * root_one_plus_epsilon_squared)
        
        # (8): Calculate the first part of the second bracket term:
        first_part_main_second_bracket_term = 8. + Decimal("5.") * epsilon**2 - Decimal("2.") * x_Bjorken * (Decimal("3.")  - root_one_plus_epsilon_squared)
        ...
        prefactor = Decimal("4.") * target_polarization * shorthand_K * t_over_Q_squared / root_one_plus_epsilon_squared**6
