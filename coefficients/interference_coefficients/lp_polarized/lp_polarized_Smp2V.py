...
def calculate_s_2_minus_plus_longitudinally_polarized_V(
    ...
    try:
        ...
        prefactor = 4. * target_polarization * (2. - lepton_energy_fraction_y) * sqrt(1. - lepton_energy_fraction_y - lepton_energy_fraction_y**2 * epsilon**2 / 4.) / root_one_plus_epsilon_squared**5
