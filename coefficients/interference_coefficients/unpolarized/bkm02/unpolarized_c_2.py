...
def calculate_c_2_unpolarized(
    ...
    try:
        ...
        c_2_I_unpolarized = coefficient_prefactor * coefficient_c_I_unpolarized

        if verbose:
            print(f"> Calculated c_2_I_unpolarized interference coefficient as: {c_2_I_unpolarized}")

        # (9): Return:
        return c_2_I_unpolarized
