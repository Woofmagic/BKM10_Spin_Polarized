...
def calculate_c_1_unpolarized(
    ...
    try:
        ...
        coefficient_prefactor = - Decimal("8. ") * kinematic_k * (Decimal("2.") - Decimal("2.") * lepton_energy_fraction_y + lepton_energy_fraction_y**2)
        ...
        c_1_I_unpolarized = coefficient_prefactor * coefficient_c_I_unpolarized

        if verbose:
            print(f"> Calculated c_1_I_unpolarized interference coefficient as: {c_1_I_unpolarized}")

        # (9): Return:
        return c_1_I_unpolarized
