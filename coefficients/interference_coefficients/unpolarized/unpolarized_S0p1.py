...
def calculate_s_1_zero_plus_unpolarized(
    ...
    try:
        ...
        y_quantity = sqrt(1. - lepton_energy_fraction_y - (epsilon**2 * lepton_energy_fraction_y**2 / 4.))

        # (3): Calculate the coefficient
        s_1_zero_plus_unp = 8. * sqrt(2.) * lepton_helicity * (2. - lepton_energy_fraction_y) * lepton_energy_fraction_y * y_quantity * k_tilde**2 / (root_one_plus_epsilon_squared * squared_Q_momentum_transfer)
