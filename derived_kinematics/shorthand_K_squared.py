...
def calculate_kinematics_k_squared( 
    ...
    try:
        ...
        one_minus_x_bjorken = Decimal("1.") - x_Bjorken

        # (2): Multiplicative Quantity Two:
        second_multiplicative_quantity = Decimal("1.") - lepton_energy_fraction_y - (lepton_energy_fraction_y**2 * epsilon**2 / Decimal("4.0"))

        # (3): Multiplicative Quantity Three:
        third_multiplicative_quantity = Decimal("1.") - (squared_hadronic_momentum_transfer_t_minimum / squared_hadronic_momentum_transfer_t)

        # (3): Multiplicative Quantity Four - First Term:
        fourth_multiplicative_quantity_first_term = sqrt(Decimal("1.") + epsilon**2)

        # (4): Multiplicative Quantity Four - Second Term - Numerator:
        fourth_multiplicative_quantity_second_term_numerator = Decimal("4.") * x_Bjorken * one_minus_x_bjorken + epsilon**2

        # (5): Multiplicative Quantity Four - Second Term - Denominator:
        fourth_multiplicative_quantity_second_term_denominator = Decimal("4.") * one_minus_x_bjorken
        ...
        k_squared = Decimal("-1.0") * k_squared_prefactor * one_minus_x_bjorken * second_multiplicative_quantity * third_multiplicative_quantity * fourth_multiplicative_quantity
